...
/**
 * Run ffprobe. The single owner of "how this process is spawned and bounded".
 *
 * Exported so `keyframes.ts` asks ffprobe the same way this file does -- one place decides
 * the binary name, the timeout kill and what a failure looks like.
 */
export const spawnFfprobe: ProbeRunner = async (argv, timeoutMs) => {
